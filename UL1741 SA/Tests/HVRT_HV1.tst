<scriptConfig name="HVRT_HV1" script="SA9_volt_ride_through">
  <params>
    ...
    <param name="vrt.test_label" type="string">hvrt_hv1</param>
  </params>
</scriptConfig>

<scriptConfig name="HFRT_HF1" script="SA10_freq_ride_through">
  <params>
    <param name="frt.n_r" type="int">1</param>
    ...
    <param name="frt.freq_test" type="float">62.0</param>
    ...
    <param name="frt.test_label" type="string">hfrt_hf1</param>
  </params>
</scriptConfig>
